...
int main(int argc, char* argv[]) {
    ...
    // Allocate memory for the image, mask, and output matrices dynamically
    ...
    cout << output[0] << endl;            // First element of the output matrix
    cout << output[n * n - 1] << endl;    // Last element of the output matrix
